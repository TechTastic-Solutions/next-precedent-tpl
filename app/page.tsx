...
const features: tFeatures[] = [
  ...
  },
  {
    ...
    description:
      "TechTastic Solutions Precedent template comes with authentication and database via [Auth.js](https://authjs.dev/) + [Prisma](https://prisma.io/)",
    demo: (
